...
def main():
    ...
    testers = ["p_13298184134", "p_13298184134_player1", "p_13298184134_player2", "p_13298184134_player3", "p_13298184134_player4", "p_13298184134_player5"]#第一个为拥有创建房间权限的账号，这里需要与yaml文件中对应，不然会找不到yaml文件中配置的密码
